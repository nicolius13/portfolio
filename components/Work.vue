    ...
    return {
      projects: [
        ...
        // Projet Express Food
        {
          ...
          description_fr:
            "4eme projet créé pour le parcour 'Dévelopeur d'application - frontend' d'OpenClassroom : Concevez la solution technique d'une application de restauration en ligne ExpressFood",
